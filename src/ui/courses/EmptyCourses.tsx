...
export function EmptyCourses({ onAdd }: EmptyCoursesProps) {
  return (
    <div className='text-center py-24 bg-card/40 backdrop-blur-md rounded-[2.5rem] border border-white/5 shadow-2xl'>
      ...
      <Button
        onClick={onAdd}
        size='lg'
        className='h-16 px-10 rounded-2xl bg-primary hover:bg-primary/90 text-white font-black text-lg shadow-xl shadow-primary/20 transition-all active:scale-95 gap-3'
      >
